                   ...
                   if(product.oldPrice != null)
                    Positioned(
                      ...
                      child: Container(
                        ...
                        //discount text
                        child: Text("${calculateDiscount(product.price, product.oldPrice!)}% OFF",
                        style:AppTextStyle.withColour(AppTextStyle.withWeight(
                  ...
                  Row(
                    children: [
                      ...
                      if (product.oldPrice != null) ...[
                        ...
                        Text('LKR ${product.oldPrice!.toStringAsFixed(2)}',
